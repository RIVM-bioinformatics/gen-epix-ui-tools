...
export const sanitizeBaseTs = (baseTsPath: string, appType: APP): void => {
  ...
  sanitizeTs(baseTsPath, content => content
    ...
    .replace(`import type { AxiosPromise, AxiosInstance, RawAxiosRequestConfig } from 'axios';`, `import type { AxiosInstance, AxiosRequestConfig, AxiosResponse, RawAxiosRequestConfig, InternalAxiosRequestConfig } from 'axios';`)
